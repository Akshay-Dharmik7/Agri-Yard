        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            echo "
                ...
                <div class='card pb-1 pl-1 pr-1 pt-0' style='height:542px'>
                    <br>
                    <div class='mt-0'><b>
                            <h4><img src='iconsmall.png' style='width: 10; margin-bottom:  10px;'> $name
                        </b></h4>
                    </div>
                    ...
                    <div class='card-body pb-0'>
                        ...
                        <div class='row'>
                            ...
                            <div class='col-12 col-xl-6 col-lg-6 col-md-6  col-sm-12'>
                                <a href='./home.php?add_cart=$product_id' class='btn btn-warning border-secondary mr-1  ' style='color:black ;font-weight:50px;display: flex;'>Add to cart<img src='carticons.png' height='20px'></a>
                            </div>
                        </div>
                    </div>
                </div>
    ...
    function getFruitsHomepage()
    {
        ...
        while ($rows = mysqli_fetch_array($run_query)) {
            ...
            echo "<div class='column kolum'>
                <div class='img-thumbnail ''>
                     <a href='./categories.php?type=$product_type'>
                        <img class='rounded mx-auto d-block images' src='../Admin/product_images//$product_image' width='350px' height='200px' style='float:left' alt='image'>
                     </a>
                </div>
            </div>";
        }
            ...
            while ($row = mysqli_fetch_assoc($run_query)) {
                ...
                echo "
                    <div class='productbox'>
                        ...
                        <br>
                        <div class='col-sm-12'> 
                        <a href='del_prod.php?id= $id'>
                                                    <button class='btn btn-block btn-primary btn-center' style='background-color:goldenrod' type='button'>
                                                        Delete Product
                                                    </button>
                                                </a>
                    </div>
        ...
        while ($row = mysqli_fetch_array($run_query)) {
            ...
            <div class='card border-dark border' >
                <div class='card-body'>
                    ...
                    <h4 class='card-subtitle mb-2  text-center'>$phone</h4>
                    <p class='card-text text-center'>$address , $pan <br><br>
                    </p>
                </div>
            </div>
        </div>";
