...
<main class="my-form">
		<div class="cotainer">
			<div class="row justify-content-center">
				<div class="col-md-8">
					<div class="card">
						<div class="card-header" style="background-color:#009a4e"><h4 style="font-style:bold;color:white">Farmer Registration<h4></div>
						<div class="card-body border border-dark"  style="background-image: url(../imgg/1598227.jpg); background-size:cover; background-opacity:0.3">
							<form name="my-form" action="FarmerRegister.php" method="post">
								...
								<div class="col-md-6 offset-md-4">
									<button type="submit" class="btn btn-primary " style="background-color:#009a4e;color:white"   name="register" value="Register">
										Register
									</button>
								</div>
							</form>
