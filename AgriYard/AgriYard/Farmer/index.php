                ...
                <div class="col-md-8">
                    <div class="card ">
                        <div class="card-header text-left" style="background-color:#009a4e">
                            <h4 style="font-style:bold;color:white;text-align:left">Hello Farmer, Please Login To
                                Continue</h4>
                        </div>
                            ...
                            <form name="my-form" action="#" method="post">
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary text-left border border-dark"
                                        style="background-color:#009a4e;color:white;float:left; margin:20px"
                                ...
                                <div class="col-md-6 offset-md-4">
                                    <label id="forgotPassword" class="text-left"><a id='link' style=""
                                            href="FarmerForgotPassword.php"><b style="color:black ;text-align:left">
                                                Forgot your password </b></a></label>
                                    <br>
                                    <label id="account" class="text-left"><a id='link' href="FarmerRegister.php"><b
