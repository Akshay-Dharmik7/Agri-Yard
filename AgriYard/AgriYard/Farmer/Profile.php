...
while ($row = mysqli_fetch_array($run_query)) {
    ...
    $pan = $row['farmer_state'];
    $bank = $row['farmer_district'];
    $comp = $row['farmer_pan']; 
    $license = $row['farmer_bank'];
}
?>
<!DOCTYPE html>
<html lang="en">
...
if(isset($_SESSION['phonenumber'])){?>
    ...
    <div class="form">
        ...
        <div class="input-group mt-4 s">
            <div class="input-group-prepend ">
                <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-pencil-alt mr-2"></i>State</span>
            </div>
            <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value=" <?php echo $pan ?> ">
        </div> 
        <div class="input-group mt-4 s">
            <div class="input-group-prepend ">
                <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-university mr-2"></i>District</span>
            </div>
            <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value=" <?php echo $bank ?>">
        </div> 
        <div class="input-group mt-4 s">
            <div class="input-group-prepend ">
                <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-building mr-2"></i>PAN</span>
            </div>
            <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value="<?php echo $comp ?>">
        </div> 
        <div class="input-group mt-4 s">
            <div class="input-group-prepend ">
                <span class="input-group-text text  " id="inputGroup-sizing-default" ><i class="fas fa-id-badge mr-2"></i>Bank Account</span>
            </div>
            <input type="text" readonly class="form-control-plaintext border border-dark" id="staticEmail" value=" <?php echo $license?>">
        </div> 
    </div>
    <center><a href="home.php" class="btn text-center" style="background-color:#292b2c;color:goldenrod">Go Back</a></center>
    
<?php } 

else{?>

    <center><h3>Please Login First...</h3><a href="home.php" class="btn text-center" style="background-color:#292b2c;color:goldenrod">Go Back</a></center>
