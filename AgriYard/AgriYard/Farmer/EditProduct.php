                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h4 class="text-center font-weight-bold">Update Your  Product <i
                            ...
                            <div class="card-body">
                                ...
                                <form name="my-form" action="#" method="post"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="phone_number" class="form-control"
                                                name="product_type" placeholder="Example . potato" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <textarea name="product_desc" id="nid_number2" class="form-control"
                                                name="product_desc" rows="3" required></textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" id="nid_number3" class="form-control"
                                                name="product_keywords" placeholder="Example best potatos" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 offset-md-4">
                                        ...
                                        &nbsp;&nbsp;
                                        <a href="MyProducts.php" class="btn btn-info">
                                            GO BACK
                                        </a>
                                    </div>
                                </form>
