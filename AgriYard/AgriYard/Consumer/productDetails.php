                                ...
                                <form actions='#' method='post'>
                                    ...
                                    <div class='row'>
                                        <div class='col-12 col-xl-6 col-lg-12 col-md-12 col-sm-12'> 
                                            <button name='cart_val' type='submit' class='btn btn-center btn-warning border-secondary addtocart' style='color:black'><b>Add to cart</b><i class='fa' style='font-size:17px; '>&#61562;</i></button>
                                        </div>
